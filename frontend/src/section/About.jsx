...
const About = () => {
  ...
  return ( 
    <section className="w-full min-h-screen bg-black font-bold text-6xl max-sm:text-3xl items-center justify-center z-3 flex flex-col relative" id="about_section">
      <div className="flex flex-col font-bold text-8xl max-sm:text-4xl text-center gap-10 max-sm:gap-6" id="intro_bundle">
      ...
      <div className="text-center absolute opacity-0 scale-15 flex flex-row max-sm:flex-col gap-4 items-center" id="p_1">
